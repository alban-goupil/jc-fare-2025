...
\title{Journées Jeunes Chercheuses/Chercheurs de FARE}
\subtitle{Ateliers?}
...
\begin{frame}{Problématique}
  \begin{itemize}
  \item Surveillance à grande échelle de l'évolution des jaunisse
...
\begin{frame}{Apprentissage}
  \begin{align*}
    \text{Modèle}^\star
    &= \argmin_\text{Modèle}\quad p(\text{Modèle}\mid \text{Données})\\
    &= \argmin_\text{Modèle}\quad
